...
<html class="no-js" lang="en">
  <head>
      ...
      <title>Dan McCurley</title>
      <meta name="description" content="Dan McCurley Web Development and Design Portfolio">
  ...
  <body id="body" class="">
    ...
    <div id="page_wrapper" class="page_wrapper clearfix">    
      ...
      <section class="main extend_vertical">
          ...
          <p>Please have a look around, and feel free to <a href="contact/contact.html" title="link to contact page">contact me</a> anytime.</p>
...
<!--         <li>
    ...
    <script>
        ...
        ga('create','UA-13117340-4','auto');ga('send','pageview');
    </script>
  </body>
</html>
